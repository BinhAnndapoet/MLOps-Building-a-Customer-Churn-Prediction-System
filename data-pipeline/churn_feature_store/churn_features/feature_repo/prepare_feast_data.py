...
def prepare_feast_data(input_csv_path, output_parquet_path="data/processed_churn_data.parquet"):
    """
    ...
    # Create created timestamp (simulate data creation time)
    ...
    df_feast.to_parquet(output_parquet_path, index=False)
